...
[`templates/`](https://github.com/WatsonWBlair/lab-os/tree/main/templates) holds the seed files
the handbook's setup and repo-creation pages copy from — each carries its own embedded author
guidance:

- [`global-CLAUDE.template.md`](https://github.com/WatsonWBlair/lab-os/blob/main/templates/global-CLAUDE.template.md)
