...
**What:** `_specs/lab-os/main/` seeded from `templates/docs/main-bundle/`. No fold: nothing
...
from folded slices.
**Why now:** the bundle lifecycle that makes a main bundle coherent landed first — creating
...
**Refs:** #81 (the lifecycle rule), and the PR that adds this directory.
