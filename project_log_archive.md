...
Overflow archive per `.claude/rules/03-logging.md` § File structure & overflow.
Grep-only, cap-exempt. Newest archived block first; entry order preserved as moved.
---
