...
- [`PR-LIFECYCLE.md`](PR-LIFECYCLE.md) — end-to-end PR lifecycle: merge bar, solo-maintainer bypass.
...
- `templates/` — starter files for new repos and members:
  ...
  - [`docs/planning/`](templates/docs/planning/) — the planning-bundle scaffolds ([`prd`](templates/docs/planning/prd.template.md) · [`spec`](templates/docs/planning/spec.template.md) · [`design`](templates/docs/planning/design.template.md) · [`plan`](templates/docs/planning/plan.template.md)), one bundle per slice under `_specs/<repo>/<DATE>-<handle>/`; `design.md` is required only when the slice meaningfully touches code
  - [`docs/main-bundle/`](templates/docs/main-bundle/) — the main-bundle scaffolds ([`prd`](templates/docs/main-bundle/prd.template.md) · [`spec`](templates/docs/main-bundle/spec.template.md) · [`design`](templates/docs/main-bundle/design.template.md) · [`plan`](templates/docs/main-bundle/plan.template.md)), one per scope at `_specs/<scope>/main/` — the current-state surface completing bundles fold into
