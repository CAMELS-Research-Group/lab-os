...
- `.claude/skills/` + `.claude/commands/` — shared Claude Code skills and their slash commands. Currently: [`pr-round`](.claude/skills/pr-round/SKILL.md) (`/pr-round`) — one round of PR work across every PR connected to you: review others' PRs, remediate review feedback on your own. Provenance: [`ATTRIBUTION.md`](.claude/skills/ATTRIBUTION.md).
