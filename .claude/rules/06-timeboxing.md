...
- At box end: append one planned-vs-actual row to the owning calibration file. **Exit met?** is judged at the timer, before any extension. Rows never go to any repo's decisions document — a calibration row is telemetry, not a decision.
