...
All working sessions and agent-executed tasks. Owning docs: `docs/timeboxing.md` (session standard v1.0), `docs/timebox_recording.md` (agent task boxes + recording mechanics). At-a-glance: `docs/timeboxing_quickref.md`. This rule is a pointer — the docs own the details; do not restate their tables here.
