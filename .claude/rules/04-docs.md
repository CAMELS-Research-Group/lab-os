...
- **Plan** — code-free: per task, Files/Depends on/Spec link/Acceptance/Verification/Agent-suitable (yes/partial/no — can an agent run it unattended)/Commit; only code blocks: shell in Verification lines. Carries `## Execution Log`.
