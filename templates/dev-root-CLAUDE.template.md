...
`lab-os/site/docs/getting-started.md`, or the handbook's Getting Started page). Foundational and paused repos are cloned on demand when a question sends you upstream.
