...
Format: lab standard, `lab-rules/.claude/rules/03-logging-and-docs.md`.

## Standing Decisions

- 2026-04-05 11:00 — adopt cache layer · #21
- 2026-03-02 14:10 — adopt widget pipeline · #12
- 2026-02-01 09:30 — pin runtime to 3.11 · #8

## Entries

## 2026-04-05 11:00 — adopt cache layer

**Decision:** Put a cache layer in front of the embedding store.
**Why:** Re-embedding identical clips dominated CI time.
**Alternatives:** Bigger runner — rejected, cost.
**Refs:** #21
